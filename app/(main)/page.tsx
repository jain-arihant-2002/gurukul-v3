...
//import { cleanupGodData, seedDatabase } from '@/db/testing_db_query';
  ...
  return (
    <>
      ...
      <section className="w-[80%] mx-auto my-12">
        ...
        {Courses ? <CourseList Courses={Courses} /> : <p>No course found</p>}
      </section>
      <section className="py-16 bg-background">
        <div className="w-[80%] mx-auto px-4">
          ...
          {Instructors ? <InstructorList Instructors={Instructors} /> : <p>No instructor found</p>}
        </div>
      </section>
    </>
  );
